...
void initControl(float a, float b, float c, float d, float e){ // gán rawvalue cho các giá trị
...
int constructControl(){
  ...
  //initControl(fron_fuzzy.rawValue,right_fuzzy.rawValue,left_fuzzy.rawValue,speed,direction_target.rawValue);
