...
#define SPA 8
#define SPB 9
const int trig_left = 10, trig_right = 11, trig_front = 32;     // chân trig của HC-SR04
const int echo_left = 7, echo_right = 12, echo_front = 30;     // chân echo của HC-SR04
...
void setup()
{
  ...
  pinMode(trig_front, OUTPUT);   // chân trig sẽ phát tín hiệu
...
void thuKhoangCach() {
  ...
  unsigned long duration_left, duration_right, duration_front; // biến đo thời gian
  ...
  FF = (duration_front / 2 / 29.412 / 100);
